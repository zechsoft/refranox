        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              PAN-India presence with regional offices for better service delivery
            </p>
          </motion.div>
            ...
            {offices.map((office, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-gray-900">{office.name.split(' - ')[1]}</h3>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    office.type === 'Primary' ? 'bg-orange-100 text-orange-600' :
                    office.type === 'Regional' ? 'bg-blue-100 text-blue-600' :
